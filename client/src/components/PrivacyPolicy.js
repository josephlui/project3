...
class PrivacyPolicy extends React.Component {
    render() {
        return <div>
            Quarky Bluebirds Privacy Policy

            This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from https://appt-booking-app.herokuapp.com (the “Site”).
            ...
            CONTACT US
            For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at tahreem.butt@mail.utoronto.ca or by mail using the details provided below:

              5125 Celebration DR, Mississauga, ON, L5M8B4, Canada
        </div>;
    }
}
